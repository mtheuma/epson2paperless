...
panel flow does job preparation that a host-triggered scan skips. On ADF models without
duplex hardware (ET-4800, ET-15000), set `SCAN_SIDES=simplex` — a duplex request is
refused rather than sent to the printer.
