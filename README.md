...
| **DS-575W**           | 🟡 Experimental | Requires [pairing](#button-only-scanner-pairing); ADF-only sheet-fed. Duplex colour PDF at 200 DPI verified on hardware; simplex, greyscale, JPG, and other DPIs replay-tested only |
