...
- `src/esci2/scanner.test.ts` replays ESC/I-2 sessions. TLS captures from the ET-4950 family assert byte-for-byte host output against Frida records. Plain-TCP ET-2750 fixtures assert completed output and session behavior from pcap-derived records.
